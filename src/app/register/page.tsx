    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-4">
      <div className="w-full max-w-md space-y-8 border border-zinc-800 p-8 rounded-2xl bg-zinc-900/50 backdrop-blur-xl">
        <div className="text-center">
          <h1 className="text-3xl font-light tracking-tighter text-zinc-100 mb-2">Initialize Identity</h1>
          <p className="text-zinc-500 text-sm">Register to begin your journey.</p>
        </div>
